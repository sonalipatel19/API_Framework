...
import com.qa.api.pojo.ContactsCredientails;
...
public class ContactsAPITest extends BaseTest{
	...
	public void generateToken() {
		...
		ContactsCredientails creds = ContactsCredientails.builder()
		.email("sonu.d.p19@gmail.com")
		.password("Sonu@123")
		.build();
		...
		ConfigManager.set("contactsBearerToken", tokenId);
	}
